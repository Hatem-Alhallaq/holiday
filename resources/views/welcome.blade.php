...
<header class="site-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-4 site-logo" data-aos="fade"><a href="{{ URL::to('/')}}"><em>Holiday Island</em></a></div>
            <div class="col-8">
...
{{--                                        <li class="active"><a href="{{asset('site/index.html')}}">Home</a></li>--}}
{{--                                        <li><a href="{{asset('site/hotel.html')}}">Hotel</a></li>--}}
{{--                                        <li><a href="{{asset('site/about.html')}}">About</a></li>--}}
...
<section class="site-hero overlay" style="background-image: url({{asset('site/img/hero_1.jpg')}})">
    <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
            <div class="col-md-10 text-center">
                <h1 class="heading" data-aos="fade-up">Welcome to <em>Holiday Island </em></h1>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 visit mb-3" data-aos="fade-right">
                <a href="{{asset('site/restaurant.html')}}"><img src="{{asset("/storage/$hotel->image")}}" alt="Image placeholder" class="img-fluid"> </a>
                <h3><a href="{{asset('site/restaurant.html')}}">{{$hotel->name}}</a></h3>
            ...
            <div class="col-md-12">
                <div class="home-slider major-caousel owl-carousel mb-5" data-aos="fade-up" data-aos-delay="200">
                    <div class="slider-item">
                        <img src="{{asset('site/img/slider-1.jpg')}}" alt="Image placeholder" class="img-fluid">
                    </div>
                    <div class="slider-item">
                        <img src="{{asset('site/img/slider-2.jpg')}}" alt="Image placeholder" class="img-fluid">
                    </div>
                    <div class="slider-item">
                        <img src="{{asset('site/img/slider-3.jpg')}}" alt="Image placeholder" class="img-fluid">
                    </div>
                    <div class="slider-item">
                        <img src="{{asset('site/img/slider-4.jpg')}}" alt="Image placeholder" class="img-fluid">
                    </div>
                    <div class="slider-item">
                        <img src="{{asset('site/img/slider-5.jpg')}}" alt="Image placeholder" class="img-fluid">
                    </div>
                    <div class="slider-item">
                        <img src="{{asset('site/img/slider-6.jpg')}}" alt="Image placeholder" class="img-fluid">
                    </div>
                </div>
                <!-- END slider -->
            </div>
...
<section class="section blog-post-entry bg-pattern">
    <div class="container">
        <div class="row justify-content-center text-center mb-5">
            <div class="col-md-8">
                <h2 class="heading" data-aos="fade-up">Our Travel Packages</h2>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="media media-custom d-block mb-4">
                    <a href="" class="mb-4 d-block"><img src="{{asset("/storage/$product->image")}}" alt="Image placeholder" class="img-fluid"></a>
                    <div class="media-body">
                        <h3 style="color: red">{{$product->price}} $</h3>
                        <h2 class="mt-0 mb-3"><a href="#')}}">{{ strip_tags($product->detailes) }}</a></h2>
                        <span class="meta-post">{{date('MM-d-Y', strtotime($product->created_at))}} </span>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
                <div class="testimonial text-center">
                    <div class="author-image mb-3">
                        <img src="{{asset('site/img/person_1.jpg')}}" alt="Image placeholder" class="rounded-circle">
                    </div>
                    <blockquote>
            ...
            <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
                <div class="testimonial text-center">
                    <div class="author-image mb-3">
                        <img src="{{asset('site/img/person_2.jpg')}}" alt="Image placeholder" class="rounded-circle">
                    </div>
                    <blockquote>
            ...
            <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
                <div class="testimonial text-center">
                    <div class="author-image mb-3">
                        <img src="{{asset('site/img/person_3.jpg')}}" alt="Image placeholder" class="rounded-circle">
                    </div>
                    <blockquote>
...
{{--            </div>--}}
        ...
        <div class="row bordertop pt-5">
            <p class="col-md-6 text-left"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">Holiday Island</a>
